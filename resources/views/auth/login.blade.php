                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="{{ route('login') }}" autocomplete="off">
                            ...
                            <div class="form-group{{ $errors->has('identity_card') ? ' has-danger' : '' }} mb-3">
                                <div class="input-group input-group-alternative">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="ni ni-email-83"></i></span>
                                    </div>
                                    <input class="form-control{{ $errors->has('identity_card') ? ' is-invalid' : '' }}" placeholder="{{ __('label.identity_card') }}" type="text" name="identity_card" value="{{ old('identity_card') }}" required autofocus>
                                </div>
