                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">
                                        Hello!</h1>
                                    <p class="text-uppercase" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        {{ $sender }} has submit {{ $programme_name }} for your review.</p>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a href="{{ action('TemplateController@index', ['id' => $programme_id]) }}"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Regards,<br>Intelligent Certificate Application (I-CAn)</p>
                                        ...
                                        <tr>
                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    ...
                                                    into your web browser: <a href="{{ action('TemplateController@index', ['id' => $programme_id]) }}"
                                                                              style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{ action('TemplateController@index', ['id' => $programme_id]) }}</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">
                                        © {{ date('Y') }} Intelligent Certificate Application (I-CAn). All rights reserved.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
