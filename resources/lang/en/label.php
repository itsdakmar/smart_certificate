...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Placeholder Language Lines - English
    |--------------------------------------------------------------------------
    |
    | The following language lines are used by the Placeholder.
    |
    */
    ...
    "programme_committees_name" => "Committee's Name",
    "programme_committees_ic" => "Committee's IC",
    "add_committees" => "Add New Committees",
    ...
    "converting_status" => "Converting Status",
